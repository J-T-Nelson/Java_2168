public class BankAccount {
    ...
    public void withdraw(double amount) {
        /*
         * Validate the amount being deposited. The balance should be more than
    ...
    public void transfer(BankAccount destAccnt, double amount) {
        ...
        if (amount > 0.0 && amount <= this.balance) {
            ...
            /*
             * The amount will be withdrawn from the source account that has initiated
             * the transfer
             */
            /*
             * 'this' refers to the calling object (the one whose name appeared in
             * front of the dot in the method call)
             */
